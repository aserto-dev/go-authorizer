...
func file_aserto_authorizer_v2_api_decision_logs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aserto_authorizer_v2_api_decision_logs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_aserto_authorizer_v2_api_decision_logs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_aserto_authorizer_v2_api_decision_logs_proto_msgTypes[2].Exporter = func(v any, i int) any {
